...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None, CI=None):
    ...
    self.camera_packets = ["roadCameraState", "driverCameraState"] if TICI else ["roadCameraState"]
    if TICI:
    ...
    self.sm = sm
    if self.sm is None:
      ignore = (['driverCameraState', 'managerState'] if TICI else ['managerState']) if SIMULATION else None
